...
/*
 * CAL_3X3 diagnostics.  Point index is 0..8 in capture order.
 * g_cal_sequence_done becomes 1 after the ninth camera trigger completes.
 */
extern volatile uint8_t g_cal_point_index;
extern volatile uint8_t g_cal_capture_count;
extern volatile uint8_t g_cal_sequence_done;
extern volatile int64_t g_cal_current_x;
extern volatile int64_t g_cal_current_y;
